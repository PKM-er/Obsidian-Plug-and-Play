...
- [[#目录^TOC|目录]]
	...
	- [[#3. 详细|3. 详细]]
		...
		- [[#3.5. plugin:obsidian-banners|3.5. plugin:obsidian-banners]]
		- [[#3.6. plugin：table-extended|3.6. plugin：table-extended]]
		- [[#3.7. plugin：强制某些页面可以使用阅读模式展示|3.7. plugin：强制某些页面可以使用阅读模式展示]]
		- [[#3.8. 样式：|3.8. 样式：]]
## 1. 概述
